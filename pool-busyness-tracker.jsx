...
const POOLS = [
  ...
  },
 {
  ...
  {
    id: 'east-end-pool-newcastle',
    name: 'East End Pool',
    location: 'Corbridge Road, Byker, NE6 1DY',
    city: 'Newcastle',
    country: 'UK',
    color: '#06B6D4',
    hours: {
  ...
  {
    id: 'gosforth-leisure-centre',
    name: 'Gosforth Leisure Centre',
    location: 'Regent Farm Road, NE3 3HD',
    city: 'Newcastle',
    country: 'UK',
    color: '#3B82F6',
    hours: {
  ...
  {
    id: 'city-baths-newcastle',
    name: 'City Baths Newcastle',
    location: 'Northumberland Road, NE1 8SF',
    city: 'Newcastle',
    country: 'UK',
    color: '#A855F7',
    hours: {
  ...
  },
  {
    ...
    location: 'Olympic Park, Stratford, E20 2AQ',
    city: 'London',
    country: 'UK',
    color: '#0EA5E9',
    hours: {
  ...
  {
    id: 'porchester-leisure-centre',
    name: 'Porchester Leisure Centre',
    location: 'Queensway, Bayswater, W2 5HS',
    city: 'London',
    country: 'UK',
    color: '#F59E0B',
    hours: {
  ...
  {
    id: 'marshall-street-leisure-centre',
    name: 'Marshall Street Leisure Centre',
    location: 'Marshall Street, Soho, W1F 7EL',
    city: 'London',
    country: 'UK',
    color: '#EF4444',
    hours: {
  ...
  {
    id: 'dulwich-leisure-centre',
    name: 'Dulwich Leisure Centre',
    location: 'East Dulwich Road, SE22 9NA',
    city: 'London',
    country: 'UK',
    color: '#14B8A6',
    hours: {
  ...
  {
    id: 'aberdeen-sports-village-aquatics-centre',
    name: 'Aberdeen Sports Village Aquatics Centre',
    location: 'Regent Walk, AB24 1SX',
    city: 'Aberdeen',
    country: 'UK',
    address: 'Regent Walk, Aberdeen AB24 1SX',
    color: '#2563EB',
    poolSize: '50m / 25m',
    lanes: 10,
    notes: 'World-class aquatics centre with a 50m 10-lane pool, 25m pool, diving facilities, sauna and steam room.',
    hours: {
      weekday: { open: '05:30', close: '22:30' },
      saturday: { open: '08:30', close: '17:00' },
      sunday: { open: '08:30', close: '17:00' }
    }
  },
  {
    id: 'get-active-northfield',
    name: 'Get active @ Northfield',
    location: 'Kettlehills Crescent, AB16 5TL',
    city: 'Aberdeen',
    country: 'UK',
    address: 'Kettlehills Crescent, Aberdeen AB16 5TL',
    color: '#7C3AED',
    poolSize: '25m',
    lanes: 5,
    notes: 'Sport Aberdeen venue with a 25m pool, public swimming, adult lane swimming and coached programmes.',
    hours: {
      weekday: { open: '06:00', close: '22:00' },
      saturday: { open: '08:00', close: '18:00' },
      sunday: { open: '08:00', close: '18:00' }
